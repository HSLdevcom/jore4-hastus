...
class JoreConverterTest {
    ...
    val VEHICLE_TYPE_1_KEY = 10
    val VEHICLE_TYPE_1_ID = UUID.randomUUID()

    val VEHICLE_TYPE_2_KEY = 20
    val VEHICLE_TYPE_2_ID = UUID.randomUUID()

    val MONDAY_DAY_TYPE_ID = UUID.randomUUID()
    val FRIDAY_DAY_TYPE_ID = UUID.randomUUID()
