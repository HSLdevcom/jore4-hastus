...
class ConversionsFromHastusTest {
    ...
    inner class TestConvertHastusDataToJore {
        ...
        fun `when converting parsed CSV to Jore object hierarchy`() {
            ...
            val journeyPatternRefsIndexedByRouteId =
                mapOf(
            ...
            val hastusData: List<ImportableItem> =
                listOf(
        ...
        fun `when journey pattern reference does not contain a stop point defined in Hastus`() {
            ...
            val exception =
                assertFailsWith<ErrorWhileProcessingHastusDataException> {
                    ConversionsFromHastus.convertHastusDataToJore(
                        hastusData,
                        vehicleTypeIndex,
                        dayTypeIndex,
    ...
    inner class TestExtractRouteLabel {
        private fun convertLabelAndVariant(
            tripRoute: String,
            variant: String
    ...
    companion object {
        ...
        fun generateVehicleScheduleRecord(dayType: Int) =
