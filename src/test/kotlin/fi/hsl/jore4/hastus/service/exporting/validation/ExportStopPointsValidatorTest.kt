...
class ExportStopPointsValidatorTest : ExportTestDataCreator {
    ...
    inner class WhenThereAreLessThanTwoStopPoints {
        private fun createLineToTest(): JoreLine =
            createLine(
                listOf(
                    createFirstStopPoint("1KALA")
    ...
    inner class WhenFirstStopPointIsNotTimingPoint {
        private fun createLineWithFirstStopPointNotAsTimingPoint(): JoreLine =
            createLine(
                listOf(
    ...
    inner class WhenLastStopPointIsNotTimingPoint {
        private fun createLineWithLastStopPointNotAsTimingPoint(): JoreLine =
            createLine(
                listOf(
                    createFirstStopPoint("1KALA"),
    ...
    companion object {
        ...
        private fun validateLine(
            line: JoreLine,
            throwExceptionOnFailedTimingPointValidation: Boolean
        ) {
