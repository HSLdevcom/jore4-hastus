...
data class RouteVariant(
    ...
    override fun toString(): String {
        return "RouteVariant(identifier='$identifier', description='$description', direction=$direction, reversible=$reversible, routeIdAndVariantId='$routeIdAndVariantId', routeId='$routeId')"
    }
}
