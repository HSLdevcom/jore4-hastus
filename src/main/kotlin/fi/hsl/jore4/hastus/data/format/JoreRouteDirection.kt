...
enum class JoreRouteDirection {
    ...
    fun toGraphQLInNetworkScope(): timetables_route_direction_enum =
        when (this) {
    ...
    companion object {
        ...
        fun from(routeDirection: route_direction_enum): JoreRouteDirection =
            when (routeDirection) {
        ...
        fun from(routeDirection: timetables_route_direction_enum): JoreRouteDirection =
            when (routeDirection) {
                // the most common first
